            ...
            <div class="card-header">
                ...
                <div class="hidden-sm-and-down">
                    <el-row :gutter="10">
                        ...
                        <el-col :span="10">
                            <el-button plain style="width: 100%;" color="#2fa7b9" @click="addLink">添加文字</el-button>
                        </el-col>
        ...
        <div>
            <el-table v-loading="loading" element-loading-text="玩命加载中..." :data="tableData" ref="multipleTableRef"
                ...
                <el-table-column label="Text">
                    <template #default="scope">
                        <el-tooltip :content="scope.row.text" placement="top" effect="light">
...
<script>
// 添加链接弹窗
import AddLink from './addText/index.vue';
import {
    ref,
    toRefs,
    reactive,
