...
<script>
    ...
    function loadData(state) {
        ...
        var data = JSON.parse(localStorage.getItem('SystemData'))
            ...
            if (data.advertising1 != "" && !data.advertising1.includes('http')) {
                data.advertising1 = url + data.advertising1
            }
            if (data.advertising2 != "" && !data.advertising2.includes('http')) {
                data.advertising2 = url + data.advertising2
            }
            if (data.advertising3 != "" && !data.advertising3.includes('http')) {
                data.advertising3 = url + data.advertising3
            }

            // 广告内容
            state.advertising1 = data.advertising1;
            state.advertisingLink1 = data.advertisingLink1;
            state.advertising2 = data.advertising2;
            state.advertisingLink2 = data.advertisingLink2;
            state.advertising3 = data.advertising3;
            state.advertisingLink3 = data.advertisingLink3;
    }
